...
class TestPickerOpen:
    def test_picker_opens_on_change_playbook(
    ...
    def test_picker_opens_on_select_playbook_empty_state(
        self, page: Page, live_server, left_panel_user, playbook_a
    ):
    ...
    def test_picker_lists_accessible_playbooks(
        self, page: Page, live_server, left_panel_user, playbook_a, playbook_b
    ):
    ...
    def test_picker_auto_expands_collapsed_panel(
        self, page: Page, live_server, left_panel_user, playbook_a, playbook_b
    ):
...
class TestSelectPlaybook:
    def test_selecting_playbook_updates_url_and_heading(
        self, page: Page, live_server, left_panel_user, playbook_a, playbook_b
    ):
        ...
        page.locator('[data-testid="browser-picker-item"]').filter(
            has_text="BetaPlaybook"
        ).click()
        page.wait_for_load_state("networkidle")
        ...
        expect(page.locator('[data-testid="browser-playbook-title"]')).to_contain_text(
            "BetaPlaybook"
        )
...
class TestCanvasSelectPlaybook:
    def test_canvas_select_playbook_opens_picker(
        ...
        canvas_btn = page.locator(
            '[data-testid="browser-empty-state"] [data-testid="browser-select-playbook"]'
        )
