...
class TestCompoundGroupingMenu:
    ...
    def test_compound_dropdown_has_three_options(self, cb_custom_graph_page: Page):
        ...
        cb_custom_graph_page.wait_for_selector(
            '[data-testid="browser-compound-dropdown"]'
        )
        none_opt = cb_custom_graph_page.locator(
            '[data-testid="browser-compound-option-none"]'
        )
        wf_opt = cb_custom_graph_page.locator(
            '[data-testid="browser-compound-option-workflow"]'
        )
        wa_opt = cb_custom_graph_page.locator(
            '[data-testid="browser-compound-option-workflow-activity"]'
        )
    ...
    def test_compound_option_workflow_activates_workflow_grouping(
    ...
    def test_compound_option_workflow_activity_activates_two_level_grouping(
        ...
        assert level == "workflow-activity", (
            f"Expected 'workflow-activity', got '{level}'"
        )
    ...
    def test_compound_active_option_shows_checkmark(self, cb_custom_graph_page: Page):
        ...
        wf_btn = cb_custom_graph_page.locator(
            '[data-testid="browser-compound-option-workflow"]'
        )
