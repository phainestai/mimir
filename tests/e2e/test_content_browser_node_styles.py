...
class TestNodeShape:
    ...
    def test_all_node_types_use_ibm_plex_sans_font(self, cb_graph_page: Page):
        ...
        for node_type in (
            ...
            style = _get_stylesheet_for_type(cb_graph_page, node_type)
            assert "IBM Plex Sans" in style["font-family"], (
                f"{node_type} missing IBM Plex Sans font"
            )
...
class TestEdgeColour:
    ...
    def test_build_edge_style_returns_array(self, cb_graph_page: Page):
